...
def main() -> None:
    ...
    p.add_argument("--ckpt", type=str, default="checkpoints_ablation/baseline", help="train.py 保存的目录")
    p.add_argument(
        "--samples",
        type=str,
    ...
    samples_path = args.samples if os.path.isabs(args.samples) else os.path.join(_project_root(), args.samples)
